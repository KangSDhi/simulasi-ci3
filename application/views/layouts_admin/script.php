...
<!-- Toastr -->
<script src="<?php echo base_url();?>assets/adminlte3/plugins/toastr/toastr.min.jsos"></script>
<!-- AdminLTE App -->
...
<!-- Flipclock -->
<script src="<?php echo base_url();?>assets/flipclock/compiled/flipclock.js"></script>
